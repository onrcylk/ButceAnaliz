        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    YatırımTürü = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Yatırım", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GelenToplamTutar = table.Column<int>(type: "int", nullable: false),
                    GidenToplamTutar = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YatırımKar = table.Column<int>(type: "int", nullable: false),
                    KullanıcıId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ElektirikFatura = table.Column<int>(type: "int", nullable: false),
                    SuFatura = table.Column<int>(type: "int", nullable: false),
                    DoğalgazFatura = table.Column<int>(type: "int", nullable: false),
                    InternetFatura = table.Column<int>(type: "int", nullable: false),
                    TelefonFatura = table.Column<int>(type: "int", nullable: false),
                    KrediTutar = table.Column<int>(type: "int", nullable: false),
                    KullanıcıId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
